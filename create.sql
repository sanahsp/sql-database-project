...
CREATE TABLE Apartment_Complex (
  ...
  Addr_State VARCHAR(50) DEFAULT NULL, -- i changed this to Addr_State because state is a keyword
...
CREATE TABLE Property_Issues (
  Project_ID INT NOT NULL DEFAULT 0, -- changed from issue_id to project_id b/c its useless otherwise
